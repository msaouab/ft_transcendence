...
const Message = ({ message, prevMessage }: { message: singleMessage, prevMessage: singleMessage }) => {
    return (
        <MessageStyle color={'#fff'} sender_id={message.sender_id} >
            <MessageContent content={message.content} sender_id={message.sender_id} id={message.id} />
